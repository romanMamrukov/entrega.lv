...
<div id="main">
  <div class="container">
   ...
   <div class="features">
    <div class="header">
     <h2>ENTREGA – ТВОЙ ПАРТНЁР В ЛОГИСТИКЕ</h2>
     <p>ДОСТАВКА ГРУЗОВ ОТ ДВЕРИ ДО ДВЕРИ</p>
    </div>
    ...
    <div class="row">
     ...
     <div class="span6 item"> <!-- two -->
      ...
      <div class="content">
       ...
       <p>Мы выполняем все виды грузовых перевозок: частичные грузы, сборные грузы, полные грузы, нестандартные грузы, негабаритные грузы, жидкие грузы и опасные грузы.</p>
      </div>
     </div>
     ...
     <div class="span6 item"> <!-- two -->
      ...
      <div class="content">
       <h4>ENTREGA услуги</h4>
	   <ul>
<li><font face="arial, helvetica, sans-serif">Выбор транспорта под заказ</font>
</li><li><font face="arial, helvetica, sans-serif">Слежение за движением грузов</font>
</li><li><font face="arial, helvetica, sans-serif">Экспедирование грузов, транспортное планирование и организация оплаты</font>
</li><li><font face="arial, helvetica, sans-serif">Мы организуем мультимодальные грузоперевозки</font>
</li><li><font face="arial, helvetica, sans-serif">Обработка документов в соответствии с потребностями и требованиями заказчика</font></li></ul>
      </div>
     </div>  
    ...
    <div class="row">
     ...
     <div class="span6 item"> <!-- one -->
      ...
      <div class="content">
       <h4>Логистика</h4>
       <p>Мы предоставляем транспортные услуги из стран Балтии, Европы, России, Белоруссии и Украины. Сотрудники нашей компании подберут наиболее выгодные решения доставки Ваших грузов.
 </p>
<p><font face="arial, helvetica, sans-serif"><strong>ENTREGA - надежный и профессиональный партнер</strong>, готовый к любой сложности задач. Мы предлагаем индивидуальный подход к каждому клиенту.
<br></font></p>
      </div>
     </div>
     ...
     <div class="span6 item"> <!-- one -->
      ...
      <div class="content">
       ...
       <p>Мы можем привлечь партнеров во всех европейских странах. Благодаря опыту наших сотрудников, грузовые перевози осуществляются качественно и в заданный срок.</p>
<p align="left"><strong>Компания имеет широкий транспортный парк:<br></strong></p>
<ul><li><font face="arial, helvetica, sans-serif">Прицепы </font>
</li><li><font face="arial, helvetica, sans-serif">Полуприцепы </font>
</li><li><font face="arial, helvetica, sans-serif">Рефрижераторы </font>
</li><li><font face="arial, helvetica, sans-serif">Платформы </font>
</li><li><font face="arial, helvetica, sans-serif">Цистерны</font>
</li><li><font face="arial, helvetica, sans-serif">Специальная техника</font>
</li></ul><br>
      </div>
     </div>
...
юридический адрес: Kalēju iela 54-2, Jūrmala, LV-2008, Latvija<br>
почта: Jūrmala, LV-2008, a.k. 2<br>
tālr.: +371 25802208<br>
tālr.: +371 26032246<br>
fakss: +371 67396076<br>
